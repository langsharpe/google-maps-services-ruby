...
describe GoogleMapsService, :integration do
  ...
  it "can make a real request" do
    ...
    expected_response = [{bounds: {northeast: {lat: 37.4239218, lng: -122.0841125},
                                   southwest: {lat: 37.4227776, lng: -122.0883048}},
                          copyrights: "Map data ©2022 Google",
                          legs: [{distance: {text: "0.3 mi", value: 435},
                                  ...
                                  start_address: "Google Building 40, 1600 Amphitheatre Pkwy, Mountain View, CA 94043, USA",
                                  start_location: {lat: 37.4227776, lng: -122.0841125},
                                  steps: [{distance: {text: "285 ft", value: 87},
                                           duration: {text: "1 min", value: 65},
                                           end_location: {lat: 37.4228869, lng: -122.0850889},
                                           html_instructions: "Head <b>west</b> toward <b>Amphitheatre Pkwy</b><div style=\"font-size:0.9em\">Restricted usage road</div>",
                                    ...
                                    {distance: {text: "105 ft", value: 32},
                                     ...
                                     html_instructions: "Turn <b>right</b> toward <b>Amphitheatre Pkwy</b><div style=\"font-size:0.9em\">Restricted usage road</div>",
                                     maneuver: "turn-right",
                                    ...
                                    {distance: {text: "377 ft", value: 115},
                                     ...
                                     html_instructions: "Slight <b>left</b> to stay on <b>Amphitheatre Pkwy</b>",
                                    ...
                                    {distance: {text: "207 ft", value: 63},
                                     ...
                                     end_location: {lat: 37.4239218, lng: -122.0883048},
                                     html_instructions: "Turn <b>left</b> onto <b>Amphitheatre Pkwy</b><div style=\"font-size:0.9em\">Destination will be on the right</div>",
                                     maneuver: "turn-left",
                                  ...
                                  traffic_speed_entry: [],
                                  via_waypoint: []}],
                          overview_polyline: {points: "kclcFtpchVEpBOpA_@IE^Eh@E`@Gr@Ez@Sv@E\\Gr@Aj@QbBo@KGAIXOjBE\\"},
