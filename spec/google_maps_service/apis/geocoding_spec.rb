...
describe GoogleMapsService::Apis::Geocoding do
  ...
  context "reverse geocode" do
    it "should call Google Maps Web Service" do
      client.reverse_geocode([-33.8674869, 151.2069902])
  ...
  context "geocode with bounds" do
    it "should call Google Maps Web Service" do
      client.geocode("Winnetka", bounds: {southwest: [34.172684, -118.604794], northeast: [34.236144, -118.500938]})
  ...
  context "geocode with region biasing" do
    it "should call Google Maps Web Service" do
      client.geocode("Toledo", region: "es")
  ...
  context "geocode with component filter" do
    it "should call Google Maps Web Service" do
      client.geocode("santa cruz", components: {country: "ES"})
  ...
  context "geocode with multiple component filters" do
    it "should call Google Maps Web Service" do
      client.geocode("Torun", components: {administrative_area: "TX", country: "US"})
  ...
  context "geocode with just components" do
    it "should call Google Maps Web Service" do
      client.geocode(nil, components: {route: "Annegatan", administrative_area: "Helsinki", country: "Finland"})
  ...
  context "reverse geocode restricted by type" do
    it "should call Google Maps Web Service" do
      client.reverse_geocode([40.714224, -73.961452], location_type: "ROOFTOP", result_type: "street_address")
  ...
  context "reverse geocode multiple location types" do
    it "should call Google Maps Web Service" do
      client.reverse_geocode([40.714224, -73.961452], location_type: ["ROOFTOP", "RANGE_INTERPOLATED"], result_type: "street_address")
  ...
  context "partial match" do
    it "should call Google Maps Web Service" do
      client.geocode("Pirrama Pyrmont")
  ...
  context "utf results" do
    it "should call Google Maps Web Service" do
      client.geocode(nil, components: {postal_code: "96766"})
